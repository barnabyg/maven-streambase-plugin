 ...
 *
 */
public final class OperatorResSearch implements XmlEntry {
     ...
     */
    public OperatorResSearch(final String directory) {
        this.directory = directory;
    }

    /**
     * Construct the object from an operator-resource-search XML node.
     *
     * @param node operator-resource-search XML node
     */
    public OperatorResSearch(final Node node) {
    ...
    public Element toXML(final Document doc) throws HelperException {
        final Element opSearch = doc.createElement("operator-resource-search");

        XMLHelper.addAttribute(doc, opSearch, DIRECTORY, directory);
